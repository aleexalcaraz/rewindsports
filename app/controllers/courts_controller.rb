class CourtsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @court.update(court_params)
        format.html { redirect_to @court, notice: "Court was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to courts_path, notice: "Court was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def court_params
      params.expect(court: [ :name, :club_id ])
    end
end
